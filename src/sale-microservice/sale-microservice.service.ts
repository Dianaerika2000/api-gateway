...
export class SaleMicroserviceService {
  ...
  async getTotalCustomers() {
    try {
      const costumers = await axios.post(`${this.configService.get('SALE_MICROSERVICE_URL')}/customer/total-customers`);
  ...
  async getTotalRevenue() {
    try {
      const sales = await axios.post(`${this.configService.get('SALE_MICROSERVICE_URL')}/sales/totalSales`);
